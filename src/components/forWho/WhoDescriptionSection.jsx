    ...
    return (
        <main id="description">
            ...
            <section>
                ...
                <p>Για αυτόν τον λόγο, δημιουργήσαμε έναν πρωτοποριακό χώρο, όπου η τεχνολογία συναντά την ανθρώπινη επαφή, προσφέροντας προσωποποιημένες υπηρεσίες φροντίδας ψυχικής υγείας που προσαρμόζονται στις ανάγκες κάθε ανθρώπου.</p>
