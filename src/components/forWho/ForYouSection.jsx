    ...
    return (
        <main id="forU">
            ...
            <div>
                ...
                <p>
                    Οι ψυχολόγοι μας καλύπτουν ένα ευρύ φάσμα θεμάτων, όπως το άγχος, η κατάθλιψη, το τραύμα, οι διαπροσωπικές σχέσεις, και η ψυχική ενδυνάμωση.
                </p>
                <p>
                    Κατανοούμε ότι κάθε άνθρωπος έχει μοναδικές ανάγκες και στόχους. Γι&apos; αυτό, η προσέγγισή μας είναι πάντα εξατομικευμένη, με βάση τις προτεραιότητες του ατόμου που έχουμε απέναντί μας.
                </p>
                <p>
