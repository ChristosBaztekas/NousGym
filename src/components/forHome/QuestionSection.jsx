    ...
    return (
        <main id="faq">
            <section>
                ...
                {/* Button with icon */}
                <a href="#appointment" className="group bg-[#FF9245] hover:bg-[#469BAF] mt-5 text-white">
